...
const host = 'http://localhost:5500/softuni-js-applications/06-client-side-rendering/exercise/03.Search-in-List/'; // Application host (NOT service host - that can be anything)
